      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-playfair mb-2">
            <span className="text-[#FFC107]">MEMELAND</span> Roadmap (2025-2026)
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Mission: Create the world's first meme-state with a physical island
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
              <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                <div>
                  ...
                  <div className="text-[#33C3F0] font-medium">
                    {phase.timeline}
                  </div>
                </div>
                <div
                  className={`px-4 py-2 rounded-full text-sm border ${getStatusColor(phase.status)}`}
                >
