...
const regions: MapRegion[] = [
  {
    ...
    y: 30,
    description:
      "Главный торговый центр острова, место встречи опытных трейдеров",
    tokenCount: 12,
    topToken: "DOGE",
    risk: "low",
  },
    ...
    <div className="bg-[#F8F9FA] py-16 px-4">
      <div className="container mx-auto">
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-4">
          Исследуйте различные регионы нашего острова, где обитают мемкоины
          разных категорий и уровней риска
        </p>
        <p className="text-center text-[#1A1F2C] font-medium mb-12">
          Площадь "SHIBA INU" • Пляж "FARTCOIN" • Лес "FLOKY" • И многое другое!
        </p>
                ...
                .map((region) => (
                  <div key={region.id}>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Badge
                        className={`${getRiskColor(region.risk)} text-white`}
                      >
                        Риск:{" "}
                        {region.risk === "low"
                          ? "Низкий"
